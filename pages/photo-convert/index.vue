    ...
    <div class="convertPG__body">
      <div class="container">
        <div class="convertPG__header">
          <nuxt-link class="header__link" active-class="active" to="/convert">
            Баннеры
          </nuxt-link>
          <nuxt-link
            class="header__link"
        ...
        <div class="convertPG__list">
          ...
          >
            <div class="item__body">
              <span>{{ i + 1 }}) {{ banner.titleBanner }}</span>
              <button
                @click="
                  convertFile(
                    banner.coverImageName.path,
                    banner.coverImageName.filename
                  )
                "
              >
                convert
...
export default {
  ...
  methods: {
    convertFile(imgPath, imgName) {
      let formData = {
        imgPath: imgPath,
        imgName: imgName,
      };
      axios
        .post(`/api/banners/convertFile`, formData)
        .then((response) => {
